...
searchDirectoryFiles(getcwd() . '/', 'package-training', $argv[1]);

searchDirectoryFiles(getcwd() . '/', 'PackageTraining', dashesToCamelCase($argv[1], true));

searchDirectoryFiles(getcwd() . '/', 'Package Training', dashesToCamelCase($argv[1], true, ' '));
