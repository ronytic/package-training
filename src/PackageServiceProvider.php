<?php
namespace ProcessMaker\Package\PackageTraining;

use Illuminate\Support\Facades\Route;
use Illuminate\Support\ServiceProvider;
use ProcessMaker\Package\Packages\Events\PackageEvent;
use ProcessMaker\Package\PackageTraining\Http\Middleware\AddToMenus;
use ProcessMaker\Package\PackageTraining\Listeners\PackageListener;

class PackageServiceProvider extends ServiceProvider
{

    // Assign the default namespace for our controllers
    protected $namespace = '\ProcessMaker\Package\PackageTraining\Http\Controllers';
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../resources/views/', 'package-training');

        $this->publishes([
            __DIR__.'/../public' => public_path('vendor/processmaker/packages/package-training'),
        ], 'package-training');
